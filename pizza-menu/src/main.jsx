      ...
      {pizzas.length > 0 ? (
        <>
          <p>
            ...
            corrupti quae deserunt pariatur, provident voluptatem eaque quas
            repudiandae numquam possimus officia architecto modi itaque
            reprehenderit inventore a similique alias!
          </p>
          <ul className="pizzas">
            {pizzas.map((pizza) => (
